...
#ifndef MINTEX_TX_CREATE_COIN_H
#define MINTEX_TX_CREATE_COIN_H

#include "tx_data.h"

namespace mintex {

class tx_create_coin: public virtual mintex::tx_data {
public:
    explicit tx_create_coin(std::shared_ptr<mintex::tx> tx);
