...
TEST(SetCandidateOn, TestEncode) {
    ...
    mintex::pubkey_t pubkey = "Mp0eb98ea04ae466d8d38f490db3c99b3996a90e24243952ce9822c6dc1e2c1a43";
    mintex::privkey_t privkey = "05ddcd4e6f7d248ed1388f0091fe345bf9bf4fc2390384e26005e7675c98b3c1";
...
TEST(SetCandidateOn, TestDecode) {
    ...
    auto data = decoded->get_data<mintex::tx_set_candidate_on>();
...
TEST(SetCandidateOff, TestDecode) {
    ...
    auto decoded = mintex::tx::decode(encoded);
    auto data = decoded->get_data<mintex::tx_set_candidate_off>();
    ASSERT_EQ(pubkey, data->get_pub_key());
}